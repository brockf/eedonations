...
$this->table->set_heading(
					array('data' => lang('eedonations_change_expiry_title'), 'colspan' => '2')
						);
...
$this->table->add_row(
		lang('eedonations_subscription_ends'),
...
$this->table->add_row(
		'',
		form_submit('submit_form', $this->lang->line('eedonations_update_subscription'))
	);
